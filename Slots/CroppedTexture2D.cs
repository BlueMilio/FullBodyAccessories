...
namespace FullBodyAccessories.Slots
{
    public struct CroppedTexture2D
    {
        ...
        public override bool Equals(object obj) =>
            obj is CroppedTexture2D ct && EqualityComparer<Texture2D>.Default.Equals(Texture, ct.Texture) &&
            Rectangle.Equals(ct.Rectangle) && Color.Equals(ct.Color);

        public override int GetHashCode()
        {
            int hashCode = -893046046;
        ...
        public static bool operator ==(CroppedTexture2D ct1, CroppedTexture2D ct2) =>
            ct1.Texture == ct2.Texture && ct1.Rectangle == ct2.Rectangle && ct1.Color == ct2.Color;
